    <footer class="bg-slate-950 text-white border-t border-white/5">
        <div class="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <nav aria-label="Services" class="flex flex-col gap-3">
                ...
                <a href="/plugins/" class="group inline-flex w-fit items-center gap-2 rounded-full border border-accent/40 bg-accent/10 px-4 py-2 text-sm font-bold text-accent hover:bg-accent hover:text-slate-950 transition-colors decoration-none">
                    Free WordPress Plugins
                    <span class="rounded-full bg-accent px-2 py-0.5 text-[9px] font-bold uppercase tracking-widest text-slate-950 group-hover:bg-slate-950 group-hover:text-accent transition-colors">New</span>
                </a>
            ...
            <div class="flex flex-col md:items-end gap-10">
                ...
                <div class="text-xs text-white/60 font-medium flex flex-col md:items-end gap-3">
                    <div class="flex flex-wrap items-center md:justify-end gap-x-4 gap-y-2">
                        ...
                        <a href="/terms-and-conditions/" class="hover:text-white transition-colors decoration-none">Terms of Service</a>
                        <span class="opacity-20">•</span>
                        <a href="/cookie-policy/" class="hover:text-white transition-colors decoration-none">Cookie Policy</a>
                        <span class="opacity-20">•</span>
    ...
    (function () {
        ...
        document.addEventListener('click', function (e) {
            ...
            var a = t.closest('a[href^="tel:"], a[href^="mailto:"], a[href*="wa.me"], a[href*="api.whatsapp.com"]');
            if (!a) return;
