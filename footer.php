        ...
        <div class="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
                ...
                <div class="mt-6 flex items-center gap-3">
                    ...
                    <a href="https://www.instagram.com/toctoc.ky/" target="_blank" rel="noopener" aria-label="TocToc Marketing on Instagram" class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/10 text-white/70 hover:bg-accent hover:text-slate-950 transition-colors">
