...
function toctoc_seo_report_html( $result, $lead = array() ) {
	...
	$h .= '<p style="color:#999;font-size:12px;margin-top:24px;">Speed / Core Web Vitals are shown live in the tool.</p>';
	...
	$h .= '<p style="font-family:Arial,sans-serif;font-size:12px;color:#94a3b8;margin-top:18px;">'
		...
		. '<a href="https://toctoc.ky/ai-search-optimization-cayman-islands/" style="color:#066CE0;">See what we do</a>.'
		. '</p>';
	$h .= '</div>';
	return $h;
}
