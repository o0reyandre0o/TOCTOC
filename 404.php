    ...
    <div class="relative z-10 mx-auto max-w-4xl px-6 pt-36 pb-24 text-center flex flex-col items-center">
        ...
        <div class="mt-16 w-full">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3">
                ...
                <a href="<?php echo esc_url( home_url( '/website-design-agency-cayman-islands/' ) ); ?>" class="rounded-full bg-white/70 border border-white/60 text-slate-700 hover:text-sky-deep hover:border-sky-deep/40 text-sm px-5 py-2.5 font-bold transition-colors decoration-none shadow-soft">Web Development</a>
