        ...
        <div class="relative z-10 mx-auto max-w-6xl px-6">
            <div class="max-w-4xl">
                ...
                <h1 class="text-5xl md:text-8xl font-display leading-[0.9] text-slate-900">
                    Web Development Agency in <em class="italic text-sky-deep font-display">Cayman.</em>
                </h1>
                ...
                <div class="mt-12 flex flex-wrap gap-4">
                    <a href="#capabilities" class="group inline-flex items-center gap-3 rounded-full bg-slate-950 text-white pl-8 pr-3 py-3 text-lg font-bold shadow-pill transition-all hover:scale-105 decoration-none">
                        Our Capabilities
