...
<main class="min-h-screen bg-background text-foreground">
    ...
    <section id="reviews" class="relative py-32 bg-[#f8fafc] text-slate-900 rounded-[3rem] mx-4 my-12 overflow-hidden">
        ...
        <div class="relative mx-auto max-w-7xl px-6">
            ...
            <!-- Floating Cards Container (H2 centered behind reviews) -->
            <div class="relative h-[1600px] md:h-[900px] w-full mt-10">
                
                <!-- CENTERED BACKGROUND TITLE (Z-0) -->
                <div class="absolute inset-0 flex flex-col items-center justify-center text-center z-0 pointer-events-none">
                    <h2 class="text-6xl md:text-[140px] font-display leading-[0.85] tracking-tighter text-black opacity-100 select-none">
                        TocToc Works <br />
                        <span class="italic">Wherever You Do</span>
                    </h2>
                    <div class="mt-12 flex flex-col items-center gap-4">
                        <div class="flex gap-1 text-yellow-500 text-3xl">★★★★★</div>
                ...
                <!-- Floating Cards (Z-10+) -->
                <!-- Review 1: Top Left -->
                <div class="absolute top-[50px] left-0 md:left-[2%] w-full md:w-[350px] bg-white p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-slate-100 z-20 float-animation hover:pause-animation transition-all duration-500 hover:shadow-2xl">
                ...
                <!-- Review 2: Top Right -->
                <div class="absolute top-[0px] right-0 md:right-[2%] w-full md:w-[380px] bg-white p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-slate-100 z-30 float-animation float-delayed-1 hover:pause-animation transition-all duration-500 hover:shadow-2xl">
                    <div class="flex items-center gap-4 mb-6">
                ...
                <div class="absolute top-[400px] md:top-[380px] left-0 md:left-[0%] w-full md:w-[340px] bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-white z-10 float-animation float-delayed-2 hover:pause-animation transition-all duration-500">
                    <div class="flex items-center gap-4 mb-6">
                ...
                <div class="absolute top-[350px] md:top-[320px] right-0 md:right-[0%] w-full md:w-[350px] bg-white p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-slate-100 z-40 float-animation float-delayed-3 hover:pause-animation transition-all duration-500 hover:shadow-2xl">
                    <div class="flex items-center gap-4 mb-6">
                ...
                <div class="absolute top-[700px] md:top-[680px] left-0 md:left-[10%] w-full md:w-[360px] bg-white p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-slate-100 z-30 float-animation float-delayed-1 hover:pause-animation transition-all duration-500 hover:shadow-2xl">
                    <div class="flex items-center gap-4 mb-6">
                ...
                <div class="absolute top-[650px] md:top-[620px] right-0 md:right-[5%] w-full md:w-[360px] bg-white p-8 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-slate-100 z-50 float-animation float-delayed-2 hover:pause-animation transition-all duration-500 hover:shadow-2xl">
                    <div class="flex items-center gap-4 mb-6">
            ...
            <div class="mt-4 flex justify-center relative z-50">
