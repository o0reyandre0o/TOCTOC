...
<main class="min-h-screen bg-background text-foreground">
    ...
    <!-- Section 6: Social Proof (Google Reviews) - Moneda Style Redesign -->
    <section id="reviews" class="relative py-32 bg-[#f8fafc] text-slate-900 rounded-[3rem] mx-4 my-12 overflow-hidden">
        <!-- Grid Background -->
        <div class="absolute inset-0 opacity-[0.1]" style="background-image: linear-gradient(#94a3b8 1px, transparent 1px), linear-gradient(90deg, #94a3b8 1px, transparent 1px); background-size: 40px 40px;"></div>
        
        <div class="relative mx-auto max-w-7xl px-6">
            <!-- Center Heading -->
            <div class="text-center mb-32 relative z-10">
                <h2 class="text-6xl md:text-8xl font-display leading-[1.1] tracking-tight text-slate-950">
                    TocToc Works <br />
                    <span class="italic text-accent">Wherever You Do</span>
                </h2>
                <div class="mt-8 flex items-center justify-center gap-4">
                    <div class="flex gap-1 text-yellow-400">★★★★★</div>
                    <div class="text-sm font-bold text-slate-400 uppercase tracking-widest">4.9/5 Rating on Google</div>
                </div>
            </div>

            <!-- Floating Cards Container -->
            <div class="relative h-[1100px] md:h-[650px] w-full mt-20">
                
                <!-- Review 1: Top Left -->
                <div class="absolute top-0 left-0 md:left-[2%] w-full md:w-[360px] bg-white p-8 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 z-20 hover:scale-105 transition-transform duration-500">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-14 h-14 rounded-full bg-accent/10 flex items-center justify-center text-accent font-bold text-xl">LF</div>
                        <div>
                            <div class="font-bold text-slate-900 leading-tight">Laura Farries</div>
                            <div class="text-xs text-slate-400">Entrepreneur · Cayman Islands</div>
                        </div>
                    </div>
                    <p class="text-xl font-bold leading-tight text-slate-800">
                        “Daniel and his team were genuinely a joy to work with. Thoughtful, generous, and always makes time for questions.”
                    </p>
                </div>

                <!-- Review 2: Top Right (Overlapping) -->
                <div class="absolute top-[280px] md:top-[-40px] right-0 md:right-[2%] w-full md:w-[380px] bg-white p-8 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 z-30 hover:scale-105 transition-transform duration-500">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-14 h-14 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 font-bold text-xl">MT</div>
                        <div>
                            <div class="font-bold text-slate-900 leading-tight">Mark Thompson</div>
                            <div class="text-xs text-slate-400">Creative Director · Paradise Paddle</div>
                        </div>
                    </div>
                    <p class="text-xl font-bold leading-tight text-slate-800">
                        “Working with Daniel at TocToc was the best experience we’ve ever had with a marketing agency! Highly recommend their AI-driven approach.”
                    </p>
                </div>

                <!-- Review 3: Middle Left -->
                <div class="absolute top-[560px] md:top-[280px] left-0 md:left-[10%] w-full md:w-[340px] bg-[#f1f5f9]/90 backdrop-blur-xl p-8 rounded-[2rem] shadow-xl border border-white/50 z-10 hover:scale-105 transition-transform duration-500">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-14 h-14 rounded-full bg-white flex items-center justify-center text-slate-400 font-bold text-xl">SJ</div>
                        <div>
                            <div class="font-bold text-slate-900 leading-tight">Sarah Jenkins</div>
                            <div class="text-xs text-slate-400">Marketing Executive · UK</div>
                        </div>
                    </div>
                    <p class="text-lg font-bold leading-tight text-slate-700">
                        “The AI-driven strategy they implemented doubled our leads in months. Professional, fast, and results-oriented. The best in the region.”
                    </p>
                </div>

                <!-- Review 4: Bottom Right -->
                <div class="absolute top-[840px] md:bottom-[-20px] md:top-auto right-0 md:right-[8%] w-full md:w-[360px] bg-white p-8 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 z-40 hover:scale-105 transition-transform duration-500">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-14 h-14 rounded-full bg-accent flex items-center justify-center text-white font-bold text-xl">JW</div>
                        <div>
                            <div class="font-bold text-slate-900 leading-tight">James Wilson</div>
                            <div class="text-xs text-slate-400">Tech Founder · Bipolaroid Studios</div>
                        </div>
                    </div>
                    <p class="text-xl font-bold leading-tight text-slate-800">
                        “I was looking for a partner who understood the AI era. TocToc precision with a local touch. Honestly, it's been a game-changer for our brand.”
                    </p>
                </div>
            ...
            <div class="mt-16 flex justify-center">
                <a href="https://www.google.com/maps/place/Toc+Toc+Marketing+-+Digital+Marketing+Agency/@19.2945176,-81.3754188,17z/data=!4m8!3m7!1s0x224ce3f8338a51c1:0xece663baba0755!8m2!3d19.2945176!4d-81.3754188!9m1!1b1!16s%2Fg%2F11t6vf_mtj?hl=en&entry=ttu&g_ep=EgoyMDI2MDQyNi4wIKXMDSoASAFQAw%3D%3D" target="_blank" class="inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/5 px-8 py-4 text-sm font-bold text-white hover:bg-white/10 transition-all decoration-none">
