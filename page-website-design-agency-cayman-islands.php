            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="group flex flex-col gap-6">
                    <div class="aspect-video rounded-[2.5rem] bg-slate-200 overflow-hidden shadow-soft">
                        <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2070&auto=format&fit=crop" alt="The Coconut Club" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    </div>
                    <div>
                        <h3 class="text-3xl font-display text-slate-900 mb-2">The Coconut Club</h3>
                        <p class="text-slate-500 mb-6">Vibrant Restaurant Website Design that captures the tropical vibe. Features mobile-optimized Digital Menu and event booking.</p>
                ...
                <div class="group flex flex-col gap-6">
                    <div class="aspect-video rounded-[2.5rem] bg-slate-200 overflow-hidden shadow-soft">
                        <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2070&auto=format&fit=crop" alt="MPJ Roofing" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    </div>
                    <div>
                        <h3 class="text-3xl font-display text-slate-900 mb-2">MPJ Roofing Supply</h3>
                        <p class="text-slate-500 mb-6">Robust Industrial Website Design built to showcase extensive product lines for contractors. B2B focused architecture.</p>
                        <a href="#" class="inline-flex items-center gap-2 font-bold text-sky-deep hover:gap-4 transition-all decoration-none">
                            Visit Website <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                        </a>
                    </div>
                </div>
